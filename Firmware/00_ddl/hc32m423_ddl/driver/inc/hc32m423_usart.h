 ...
 * @retval None
 */
__STATIC_INLINE void USART_EnableNoiseFilter(M4_USART_TypeDef *USARTx)
{
 ...
 * @retval None
 */
__STATIC_INLINE void USART_DisableNoiseFilter(M4_USART_TypeDef *USARTx)
{
 ...
 * @retval None
 */
__STATIC_INLINE void USART_EnableMultProcessor(M4_USART_TypeDef *USARTx)
{
 ...
 * @retval None
 */
__STATIC_INLINE void USART_DisableMultProcessor(M4_USART_TypeDef *USARTx)
{
 ...
 * @retval Receive data
 */
__STATIC_INLINE uint16_t USART_RecData(M4_USART_TypeDef *USARTx)
{
...
en_functional_state_t USART_GetFuncState(M4_USART_TypeDef *USARTx,
                            uint32_t u32Func);
en_flag_status_t USART_GetFlag(M4_USART_TypeDef *USARTx,
                                        uint32_t u32Flag);
...
en_result_t USART_SetTransmissionType(M4_USART_TypeDef *USARTx,
                                            uint32_t u32Type);
...
en_result_t USART_SetDataWidth(M4_USART_TypeDef *USARTx,
                                    uint32_t u32DataWidth);
uint32_t USART_GetDataWidth(M4_USART_TypeDef *USARTx);
en_result_t USART_SetOversmaplingBits(M4_USART_TypeDef *USARTx,
