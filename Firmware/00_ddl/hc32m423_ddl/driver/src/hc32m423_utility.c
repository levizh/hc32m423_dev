 ...
 * @brief This file provides utility functions for DDL.
 @verbatim
   Change Logs:
   Date             Author          Notes
   2020-01-01       Yangjp          First version
 @endverbatim
 *******************************************************************************
 ...
 * @{
 */
#define DDL_UART_CH                     (M4_USART4)
#define DDL_UART_PWC_FCG                (CMU_FCG_UART4)
#define DDL_UART_GPIO_TX_PFSR           (M4_GPIO->PFSR70)  /* PH15: USART4_TX */
#define DDL_UART_GPIO_TX_FUNC           (5U)               /* GPIO function: USART4_TX */
...
en_result_t DDL_PrintfInit(void)
{
    ...
    if (0U != READ_REG16_BIT(M4_GPIO->PWPR, GPIO_PWPR_WE))
    {
        ...
        WRITE_REG32(DDL_UART_CH->CR1, (USART_CR1_CPE | USART_CR1_CORE | USART_CR1_CFE));
