...
int32_t main(void)
{
    ...
    /* Enable CRC. */
    CLK_FcgPeriphClockCmd(CLK_FCG_CRC, Disable);
    ...
    while (1)
    {
        ...
        CRC_Calculate(CRC_CRC16, (uint16_t *)&u16SrcData[0U], CRC16_InitVal, 1U, CRC_BW_16);
        CRC_Calculate(CRC_CRC32, (uint16_t *)&u16SrcData[0U], CRC32_InitVal, 1U, CRC_BW_16);

        /* Calculates word data's CRC16 checksum and CRC32 checksum. */
        CRC_Calculate(CRC_CRC16, (uint32_t *)&u32SrcData[0U], CRC16_InitVal, 1U, CRC_BW_32);
        CRC_Calculate(CRC_CRC32, (uint32_t *)&u32SrcData[0U], CRC32_InitVal, 1U, CRC_BW_32);

        /* Checks byte data's CRC16 checksum and CRC32 checksum. */
        u8SrcData[0U]  = 0xC8U;
        u16Checksum     = 0xBA3CU;
        CRC_Check(CRC_CRC16, (uint32_t)u16Checksum, (uint8_t *)&u8SrcData[0U], CRC16_InitVal, 1U, CRC_BW_8);
        u32Checksum     = 0x47BDA50FUL;
        CRC_Check(CRC_CRC32, u32Checksum, (uint8_t *)&u8SrcData[0U], CRC32_InitVal, 1U, CRC_BW_8);

        /* Checks half word data's CRC16 checksum and CRC32 checksum. */
        u16SrcData[0U] = 0x1234U;
        u16Checksum     = 0xED16U;
        CRC_Check(CRC_CRC16, (uint32_t)u16Checksum, (uint16_t *)&u16SrcData[0U], CRC16_InitVal, 1U, CRC_BW_16);
        u32Checksum     = 0x094A9040UL;
        CRC_Check(CRC_CRC32, u32Checksum, (uint16_t *)&u16SrcData[0U], CRC32_InitVal, 1U, CRC_BW_16);

        /* Checks word data's CRC16 checksum and CRC32 checksum. */
        u32SrcData[0U] = 0x12345678UL;
        u16Checksum     = 0xF428U;
        CRC_Check(CRC_CRC16, (uint32_t)u16Checksum, (uint32_t *)&u32SrcData[0U], CRC16_InitVal, 1U, CRC_BW_32);
        u32Checksum     = 0xAF6D87D2UL;
        CRC_Check(CRC_CRC32, u32Checksum, (uint32_t *)&u32SrcData[0U], CRC32_InitVal, 1U, CRC_BW_32);
