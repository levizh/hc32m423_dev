...
/**
 * @addtogroup EMB_CMP_Brake_Timerb
 * @{
 */
...
static void EmbIrqCallback(void)
{
    ...
    if(Set == EMB_GetStatus(EMB_GROUP1_TMRB, EMB_FLAG_CMP))
    {
        ...
        EMB_ClearStatus(EMB_GROUP1_TMRB, EMB_FLAG_CMP);  /* Clear CMP Brake */
    }
}

/**
 * @brief  Main function of EMB CMP brake Timerb
 * @param  None
...
int32_t main(void)
{
    ...
    EMB_IntCmd(EMB_GROUP1_TMRB, EMB_INT_CMP, Enable);
